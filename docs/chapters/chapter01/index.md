...
![計算論的物理主義の概念フレームワーク](../../assets/images/diagrams/computational-physicalism-framework.svg)

上図は、計算論的物理主義の三層構造を示しています。物理法則層が基盤となり、その上に計算プロセス層、そして認知現象層が構築されます。この階層構造が、人間とAIの知性の等価性を理解する鍵となります。
