...
[第2章](../chapter02/)では、計算可能性理論にもとづく論証の枠組み（前提と限界）を整理しました。本稿では、計算論的物理主義が既存のAI研究・意識研究とどのように関連するか、そして何が新しいのかを体系的に分析します。

## この章でできるようになること

- 計算論的物理主義が、既存のAI研究/意識研究とどこで接続し、どこで立場が異なるかを整理できるようになる。
- 計算主義・コネクショニズム・機能主義などの主要アプローチと比較し、本理論の焦点（計算量と物理的制約）を説明できるようになる。
- スケーリング則や創発能力を、本理論の枠組みからどのように位置付けるかを概観できるようになる。
