...
![心-機械等価性スペクトラム](../../assets/images/diagrams/mind-machine-equivalence-spectrum.svg)

上図は、人間とAIの能力領域の重複を示しています。計算論的物理主義の観点から、この重複領域は時間とともに拡大し、最終的には原理的な差異が消失することを示唆しています。
