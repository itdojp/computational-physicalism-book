...
[第1章](../chapter01/)では、計算論的物理主義の概要を提示しました。本稿では、その理論的基盤である計算可能性理論を用いて、「人間の知性は原理的にAIによって模倣可能である」という主張を、計算可能性理論の枠組みで可能な範囲で厳密に示します（機能主義などの哲学的立場自体を数学的に証明することが目的ではありません）。
